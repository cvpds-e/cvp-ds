...
const tokens = [
  ...
  ['Card actions', '--cvp-button-icon-gallery-*', '--cvp-color-gallery-overlay / --cvp-color-interactive-overlay-medium', 'Shared 24px Icon Button: contrast-safe dark glass at rest, neutral overlay on hover', 'Edit / delete'],
