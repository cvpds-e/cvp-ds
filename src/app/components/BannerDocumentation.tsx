...
import './BannerDocumentation.css';

const tokens = [
  ['Info surface', '--cvp-notification-banner-info-bg', '--cvp-color-state-info-bg', 'Theme-resolved status surface', 'variant="info"'],
  ['Info icon', '--cvp-notification-banner-info-icon', '--cvp-color-state-info-text', 'Matches the localized-field available blue', 'variant="info"'],
