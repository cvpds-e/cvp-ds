...
- A facet can provide `titleTooltip` when its filtering meaning needs brief contextual guidance. Place it beside the facet title and use the shared Tooltip component.
