...
const tokenRows: ComponentTokenContractRow[] = [
  ...
  { role: 'Multi Select surface alias', token: '--cvp-multi-select-tag-bg', source: '--cvp-pill-bg', contract: 'Uses the Pills foundation', activation: 'Selected Multi Select value' },
  { role: 'Multi Select text alias', token: '--cvp-multi-select-tag-text', source: '--cvp-pill-text', contract: 'Uses the Pills foundation', activation: 'Selected Multi Select value' },
...
export function PillsDocumentation() {
  return (
    <main className="cvp-input-doc cvp-pill-doc">
      <header className="cvp-input-doc__hero">
        <div><span>Component 14 · Standardized</span><h1>Pills</h1></div>
      ...
      <section className="cvp-input-doc__panel">
        <header><b>01</b><div><h2>Shared anatomy</h2><p>Pills owns a visible value and an optional named removal action; its parent owns all selection behaviour.</p></div></header>
        <div className="cvp-input-doc__anatomy">
          <div className="cvp-input-doc__live cvp-pill-doc__live"><Pills onRemove={() => undefined} removeLabel="Remove Editorial">Editorial</Pills></div>
      ...
      <section className="cvp-input-doc__panel">
        <header><b>02</b><div><h2>Multi Select baseline</h2><p>The standalone representation and the selected value in Multi Select use the same Pills markup, CSS, and base tokens.</p></div></header>
        <div className="cvp-pill-doc__comparison">
          <article><span className="cvp-pill-doc__caption">Standalone Pills</span><Pills onRemove={() => undefined} removeLabel="Remove Editorial">Editorial</Pills></article>
      ...
      <section className="cvp-input-doc__panel">
        ...
        <div className="cvp-input-doc__themes">
          <article data-theme="dark"><span>Dark</span><div><Pills onRemove={() => undefined} removeLabel="Remove Editorial">Editorial</Pills></div></article>
          <article data-theme="light"><span>Light</span><div><Pills onRemove={() => undefined} removeLabel="Remove Editorial">Editorial</Pills></div></article>
        </div>
      </section>

      <section className="cvp-input-doc__panel">
        <header><b>04</b><div><h2>Token contract</h2><p>Multi Select retains documented aliases, but each selected-value role resolves from the shared Pills foundation.</p></div></header>
        <ComponentTokenContract label="Pills token contract" rows={tokenRows} />
      </section>
      ...
      <footer className="cvp-input-doc__footer"><span>CVP selected-value foundation</span><p>Pills · Multi Select · Tokens · Keyboard · Theme parity</p></footer>
    </main>
  );
}
