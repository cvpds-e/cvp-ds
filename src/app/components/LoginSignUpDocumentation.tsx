...
const tokenRows = [
  ...
  ['Error surface', '--cvp-login-error-bg', '--cvp-color-state-error-bg', 'Inline authentication error', 'Error'],
  ['Error boundary', '--cvp-login-error-border', '--cvp-color-state-error-border', 'Error perimeter', 'Error'],
...
export function LoginSignUpDocumentation() {
  ...
  return <main className="login-docs documentation-container">
    <header className="login-docs__hero"><span>Pages</span><h1>Login / Sign Up</h1><p>A unified, theme-aware authentication page composed from the canonical CVP form and action components. Sign-in and account-creation flows now share one visual and behavioral contract.</p></header>
    ...
    <section className="login-docs__section" aria-labelledby="login-anatomy"><div className="login-docs__section-heading"><div><span>02</span><h2 id="login-anatomy">Composition and states</h2></div><p>Product layout owns the page shell; child components retain their established contracts.</p></div><div className="login-docs__grid">
      ...
      <article><AlertCircle /><strong>Service feedback</strong><p>Error and loading states remain visible, readable and structurally associated with the current action.</p></article>
