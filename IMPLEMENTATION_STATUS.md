...
- Added visual documentation and `MISC_INPUT_STANDARDIZATION.md` engineering handoff.
...
- Added visual documentation and `TEXT_BUTTON_STANDARDIZATION.md` engineering handoff.
...
- Added visual documentation and `ICON_BUTTON_WITH_TEXT_STANDARDIZATION.md` engineering handoff.
...
- Added visual documentation and `ICON_SMALL_BUTTON_STANDARDIZATION.md` engineering handoff.
...
- Added visual documentation and `ICON_BUTTON_STANDARDIZATION.md` engineering handoff.
...
- Added visual documentation and `OUTLINE_BUTTON_STANDARDIZATION.md` engineering handoff.
...
- Added a visual token contract and `SECONDARY_BUTTON_STANDARDIZATION.md` engineering handoff.
...
- Added visual Token Contract documentation and `PRIMARY_BUTTON_STANDARDIZATION.md` engineering handoff.
...
|------|------|--------|-------|
| `src/styles/cvp-primitives.css` | 1 — Primitive | ✅ Expanded | Raw values: colour, spacing, typography, radius, border width, shadow dimensions, depth, motion, opacity, z-index |
| `src/styles/cvp-semantic-tokens.css` | 2 — Semantic | ✅ Expanded | Full light + dark color, density spacing, shape roles, border recipes, elevation planes, and theme-aware focus/shadows |
| `src/styles/cvp-component-tokens.css` | 3 — Component | 🔄 Active migration | Existing override surfaces retained; pilot components and foundation contracts now resolve through Tier 2 |
| `src/styles/cvp-alias-bridge.css` | Migration | ✅ Complete | All 53 `--tc-*` production tokens aliased to `--cvp-*`. Zero breaking changes. |
...
- Full engineering handoff: `TEXT_INPUT_STANDARDIZATION.md`.
...
- Full engineering handoff: `TEXT_AREA_SELECT_STANDARDIZATION.md`.
